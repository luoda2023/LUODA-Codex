...
pub fn install_entrypoints() -> InstallActionResult {
    luoda_codex_core::install::install_entrypoints(&InstallOptions::default())
}

pub fn uninstall_entrypoints(options: InstallOptions) -> InstallActionResult {
    luoda_codex_core::install::uninstall_entrypoints(&options)
}

pub fn repair_shortcuts() -> InstallActionResult {
    luoda_codex_core::install::repair_entrypoints(&InstallOptions::default())
}
