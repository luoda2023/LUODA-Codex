...
const APP_STATE_DIR: &str = ".luoda-codex-data";
const SETTINGS_FILE: &str = "settings.json";
const LATEST_STATUS_FILE: &str = "latest-status.json";
const DIAGNOSTIC_LOG_FILE: &str = "luoda-codex.log";
...
mod tests {
    ...
    fn default_settings_path_uses_app_state_directory() {
        ...
        assert!(path.ends_with(".luoda-codex-data/settings.json"));
    }
    ...
    fn default_latest_status_path_uses_app_state_directory() {
        ...
        assert!(path.ends_with(".luoda-codex-data/latest-status.json"));
    }
    ...
    fn default_diagnostic_log_path_uses_app_state_directory() {
        ...
        assert!(path.ends_with(".luoda-codex-data/luoda-codex.log"));
    }
}
