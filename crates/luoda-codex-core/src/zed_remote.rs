...
pub enum ZedRemoteError {
    ...
    #[error("Cannot read LuodaCodex Zed remote project registry")]
    RegistryRead(#[source] std::io::Error),
    #[error("Cannot parse LuodaCodex Zed remote project registry")]
    RegistryParse(#[source] serde_json::Error),
    #[error("Cannot write LuodaCodex Zed remote project registry")]
