...
pub enum ZedRemoteError {
    ...
    #[error("Cannot read Luoda-Codex Zed remote project registry")]
    RegistryRead(#[source] std::io::Error),
    #[error("Cannot parse Luoda-Codex Zed remote project registry")]
    RegistryParse(#[source] serde_json::Error),
    #[error("Cannot write Luoda-Codex Zed remote project registry")]
