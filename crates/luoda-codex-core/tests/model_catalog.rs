...
use luoda_codex_core::model_catalog::{
    read_codex_model_catalog, read_codex_model_catalog_from_home,
};
use luoda_codex_core::settings::{
...
async fn model_catalog_uses_active_relay_profile_model_list_for_display() {
    ...
    let previous_settings_path =
        luoda_codex_core::paths::set_settings_path_for_tests(Some(settings_path.clone()));
    unsafe {
    ...
    luoda_codex_core::paths::set_settings_path_for_tests(previous_settings_path);
